#include "Generator.h"
/**
 * @brief Функция, която добавя сортирано песните във вектор от песни по критерия за рейтинг 
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Помощна функция за добавяне на песни към вектор от песни по критерии на включени жанрове
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Помощна функция за добавяне на песни към вектор от песни по критерии на изключени жанрове
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Функция, която добавя сортирано песните във вектор от песни по критерия за песни, според любимите на юзъра песни в профила му
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Функция, която добавя сортирано песните във вектор от песни по критерия за песни, според който или добавя песни от включените жанрове, или НЕ включва песни от избраните жанрове
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Функция, която добавя сортирано песните във вектор от песни по критерия за година на песните 
 * 
 * @param songs 
 * @param plSize 
 * @param plList 
...
/**
 * @brief Функция, която определя кой критерий да ползва
 * 
 * @param input 
 * @param songs 
 * @param plSize 
...
/**
 * @brief Функция която върши основната работа по генериране на плейлиста.
 * 
 * @param songs 
 * @param user 
 */
